...
exclude_patterns = ['_build', 'test_*', 'tests/*', 'Thumbs.db', '.DS_Store']
...
html_theme_options = {
    ...
    'show_related': 'true'      # TODO: replace with sidebar_collapse @ 0.7.9
}
...
texinfo_documents = [
    (master_doc, 'camelid', 'Camelid Documentation',
     author, 'camelid', 'Project for meta-organizing chemical and material libraries.',
     'Miscellaneous'),
]
